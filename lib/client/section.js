...
function field(label, value, onChange, placeholder = '') {
    return createElement('div', null, createElement('label', { style: labelStyle }, label), createElement('input', {
        style: inputStyle,
        value,
        placeholder,
...
export function ShortcutSection() {
    ...
    return createElement('div', { style: { padding: '4px 0', maxWidth: '560px' } }, createElement('p', { style: { fontSize: '13px', lineHeight: 1.6, margin: '0 0 6px' } }, intro), field('Shortcut / window name', name, setName), field('Command (server to run)', command, setCommand, 'e.g. npx --yes @deepseek-ai/dsh web'), field('Browser URL when ready', url, setUrl, 'http://127.0.0.1:3080'), field('Working directory (optional)', workDir, setWorkDir, 'e.g. C:\\my\\project'), createElement('button', {
        style: buttonStyle,
        disabled: busy,
        onClick: () => void submit(),
